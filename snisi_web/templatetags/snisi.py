...
def provider_allowed(provider, slug_location):
    slug, location = split_or_none(slug_location, 2, char=":")
    return provider_is_allowed(provider=provider, slug=slug, location=location)
