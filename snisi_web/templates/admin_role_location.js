var role_entity_map = {
	...
	'central': ['country', 'region', 'health_district'],
	'charge_sis': ['health_region', 'health_district'],
	'guest': ['country', 'region', 'health_district'],
	'partner': ['country', 'region', 'health_district'],
	'pf_msi': ['region'],
