...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Action'
        db.create_table(u'snisi_core_action', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('slug', self.gf('django.db.models.fields.CharField')(max_length=250)),
            ('provider', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['snisi_core.Provider'])),
            ('on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('iface', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('domain', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['snisi_core.Domain'], null=True, blank=True)),
            ('instance_cls', self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True)),
            ('instance_pk', self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True)),
            ('payload', self.gf('picklefield.fields.PickledObjectField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'snisi_core', ['Action'])


    def backwards(self, orm):
        # Deleting model 'Action'
        db.delete_table(u'snisi_core_action')
    ...
    models = {
        ...
        u'snisi_core.action': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'iface': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'instance_cls': ('django.db.models.fields.CharField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
            'instance_pk': ('django.db.models.fields.CharField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
            'on': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'payload': ('picklefield.fields.PickledObjectField', [], {'null': 'True', 'blank': 'True'}),
            'provider': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['snisi_core.Provider']"}),
        ...
        u'snisi_core.expectedreporting': {
            ...
            'arrived_reports': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "u'expected_reportings'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['snisi_core.SNISIReport']"}),
        ...
        u'snisi_core.periodictask': {
            'Meta': {'object_name': 'PeriodicTask'},
            'category': ('django.db.models.fields.CharField', [], {'max_length': '300', 'null': 'True', 'blank': 'True'}),
            'created_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'slug': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '255'}),
            'triggered': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'triggered_on': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'})
        },
        ...
        u'snisi_core.snisireport': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'ec999141-a498-4aac-82fe-4b3a1962f0f8'", 'max_length': '200', 'primary_key': 'True'}),
