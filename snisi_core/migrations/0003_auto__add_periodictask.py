...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'snisi_core_periodictask', (
            ...
            ('triggered', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('triggered_on', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'snisi_core', ['PeriodicTask'])


    def backwards(self, orm):
        # Deleting model 'PeriodicTask'
        db.delete_table(u'snisi_core_periodictask')
    ...
    models = {
        ...
        u'snisi_core.snisireport': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'a5e6a642-6296-490e-93c7-da11eb332630'", 'max_length': '200', 'primary_key': 'True'}),
