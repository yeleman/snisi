...
class EpidemiologyExcelForm(EpidemiologyRIntegrityChecker, ExcelForm):
    ...
    _mapping = {'0.1': {
        ...
        'ebola_case': ExcelFormField('D7', int,
            EpidemiologyR._meta.get_field('ebola_case').verbose_name),
        'ebola_death': ExcelFormField('F7', int,
            EpidemiologyR._meta.get_field('ebola_death').verbose_name),
        'acute_flaccid_paralysis_case': ExcelFormField('D8', int,
            EpidemiologyR._meta.get_field('acute_flaccid_paralysis_case').verbose_name),
        'acute_flaccid_paralysis_death': ExcelFormField('F8', int,
            EpidemiologyR._meta.get_field('acute_flaccid_paralysis_death').verbose_name),
        'influenza_a_h1n1_case': ExcelFormField('D9', int,
            EpidemiologyR._meta.get_field('influenza_a_h1n1_case').verbose_name),
        'influenza_a_h1n1_death': ExcelFormField('F9', int,
            EpidemiologyR._meta.get_field('influenza_a_h1n1_death').verbose_name),
        'cholera_case': ExcelFormField('D10', int,
            EpidemiologyR._meta.get_field('cholera_case').verbose_name),
        'cholera_death': ExcelFormField('F10', int,
            EpidemiologyR._meta.get_field('cholera_death').verbose_name),
        'red_diarrhea_case': ExcelFormField('D11', int,
            EpidemiologyR._meta.get_field('red_diarrhea_case').verbose_name),
        'red_diarrhea_death': ExcelFormField('F11', int,
            EpidemiologyR._meta.get_field('red_diarrhea_death').verbose_name),
        'measles_case': ExcelFormField('D12', int,
            EpidemiologyR._meta.get_field('measles_case').verbose_name),
        'measles_death': ExcelFormField('F12', int,
            EpidemiologyR._meta.get_field('measles_death').verbose_name),
        'yellow_fever_case': ExcelFormField('D13', int,
            EpidemiologyR._meta.get_field('yellow_fever_case').verbose_name),
        'yellow_fever_death': ExcelFormField('F13', int,
            EpidemiologyR._meta.get_field('yellow_fever_death').verbose_name),
        'neonatal_tetanus_case': ExcelFormField('D14', int,
            EpidemiologyR._meta.get_field('neonatal_tetanus_case').verbose_name),
        'neonatal_tetanus_death': ExcelFormField('F14', int,
            EpidemiologyR._meta.get_field('neonatal_tetanus_death').verbose_name),
        'meningitis_case': ExcelFormField('D15', int,
            EpidemiologyR._meta.get_field('meningitis_case').verbose_name),
        'meningitis_death': ExcelFormField('F15', int,
            EpidemiologyR._meta.get_field('meningitis_death').verbose_name),
        'rabies_case': ExcelFormField('D16', int,
            EpidemiologyR._meta.get_field('rabies_case').verbose_name),
        'rabies_death': ExcelFormField('F16', int,
            EpidemiologyR._meta.get_field('rabies_death').verbose_name),
        'acute_measles_diarrhea_case': ExcelFormField('D17', int,
            EpidemiologyR._meta.get_field('acute_measles_diarrhea_case').verbose_name),
        'acute_measles_diarrhea_death': ExcelFormField('F17', int,
            EpidemiologyR._meta.get_field('acute_measles_diarrhea_death').verbose_name),
        'other_notifiable_disease_case': ExcelFormField('D18', int,
            EpidemiologyR._meta.get_field('other_notifiable_disease_case').verbose_name),
        'other_notifiable_disease_death': ExcelFormField('F18', int,
            EpidemiologyR._meta.get_field('other_notifiable_disease_death').verbose_name),
        }
    }
